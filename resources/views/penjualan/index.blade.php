                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <a href="{{route('penjualan.view', $item->id)}}" class="btn text-secondary font-weight-bold text-xs"
                                            ...
                                            <table class="table align-items-center justify-content-center mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="align-middle">
                                                            <a href="/penjualan/view/{{$item->id}}" class="btn text-secondary font-weight-bold text-xs"
                                                                data-toggle="tooltip" data-original-title="">
                                                                lihat
                                                            </a>
                                                            <a href="{{route('penjualan.delete', $item->id)}}" class="btn text-secondary font-weight-bold text-xs"
